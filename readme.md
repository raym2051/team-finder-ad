# TeamFinder — платформа для поиска команды и проектов

## Описание проекта

TeamFinder — это веб-приложение, созданное для помощи разработчикам, дизайнерам и другим IT-специалистам в поиске единомышленников для совместной работы над проектами. Платформа позволяет:

- Создавать проекты с описанием, стеком технологий и требованиями к участникам
- Находить проекты по интересам и навыкам
- Приглашать участников в свои проекты
- Управлять статусом проекта (открыт/закрыт)
- Общаться с участниками (в разработке)
...
- **Tools**: isort, black, flake8 (code style)

## Автор

- **Raym2051** - [GitHub](https://github.com/raym2051)
